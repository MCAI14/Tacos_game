...
let Tacos_Malvados: Sprite = null
game.splash("Jogo dos tacos")
tiles.setCurrentTilemap(tilemap`level8`)
let Miguel = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . b 5 5 b . . . 
    . . . . . . b b b b b b . . . . 
    ...
    . . . c c c c c c c c b b . . . 
    `, SpriteKind.Player)
controller.moveSprite(Miguel, 150, 0)
Miguel.setPosition(91, 97)
info.setScore(0)
info.setLife(5)
game.onUpdateInterval(500, function () {
    Tacos_Malvados = sprites.create(img`
        ...
        . . 4 4 e e e . . . . . . . . . 
        `, SpriteKind.Food)
    Tacos_Malvados.setPosition(randint(10, 145), 5)
    Tacos_Malvados.setVelocity(0, 10)
})
